...
<head>
    ...
    <link rel="shortcut icon" href="${static_resource}/static/img/favicon.png">

    <title>学习笔记 - 个人网站</title>
...
<script src="${static_resource}/static/js/soon/plugins.js"></script>
<script src="${static_resource}/static/js/soon/custom.js"></script>
